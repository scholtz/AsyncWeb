...
class PHPArticle implements ArticleV2 {
    ...
    private function __construct() {
        ...
        if (Group::is_in_group("PHPEditor")) {
            if (isset($_REQUEST["newphparticle"])) {
                Session::set("newphparticle", "1");
                Header::s("reload", array("newphparticle" => ""));
                exit;
            }
            ...
            if ($this->show) {
                $form = array("table" => "articles", "col" => array(array("name" => "Time", "form" => array("type" => "textbox"), "data" => array("col" => "od", "datatype" => "date"), "filter" => array("type" => "date", "format" => "d.m.Y H:i:s"), "usage" => array("DBVs", "DBVe")), array("name" => "Text", "form" => array("type" => "textbox"), "data" => array("col" => "text", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "value"), "data" => array("col" => "type"), "texts" => array("text" => "php"), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "value"), "data" => array("col" => "category"), "texts" => array("text" => "PHP::MainMenu::getCurrentId()"), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "value"), "data" => array("col" => "created"), "texts" => array("text" => "PHP::Time::get()"), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Logintype", "form" => array("type" => "select"), "data" => array("col" => "logintype", "datatype" => "enum"), "filter" => array("type" => "option", "option" => array("all" => "Všetci vidia obsah", "notlogged" => "Iba neprihlásení", "logged" => "Prihlásení")), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Group", "form" => array("type" => "selectDB"), "data" => array("col" => "group", "allowNull" => true, "fromTable" => "groups", "fromColumn" => "name", "dictionary" => true,), "texts" => array("nullValue" => "Vyber",), "usage" => array("MFi", "MFu", "MFd")),), "where" => array("type" => "php", "category" => "PHP::MainMenu::getCurrentId()",), "order" => array("od" => "asc",), "uid" => "articles_php", "show_export" => true, "show_filter" => true, "allowInsert" => true, "allowUpdate" => true, "allowDelete" => true, "useForms" => true, "rights" => array("insert" => "PHPEditor", "update" => "PHPEditor", "delete" => "PHPEditor",), "execute" => array("onInsert" => "PHP::PHPArticle::onInsert", "onUpdate" => "PHP::PHPArticle::onUpdate", "onDelete" => "PHP::PHPArticle::onDelete",), "iter" => array("per_page" => "20"),);
