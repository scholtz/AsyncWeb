...
class Calendar {
    ...
    public static function getHolidays() {
        ...
        $holidays = array(Time::get(mktime(0, 0, 0, 1, 1, 2012)) => "Deň vzniku Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 1, 6, 2012)) => "Zjavenie Pána (Traja králi) - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 4, 6, 2012)) => "Veľký piatok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 4, 9, 2012)) => "Veľkonočný pondelok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 1, 2012)) => "Sviatok práce - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 8, 2012)) => "Deň víťazstva nad fašizmom - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 7, 5, 2012)) => "Sviatok svätého Cyrila a Metoda - štátny sviatok", Time::get(mktime(0, 0, 0, 8, 29, 2012)) => "Výročie SNP - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 1, 2012)) => "Deň Ústavy Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 15, 2012)) => "Sedembolestná Panna Mária - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 1, 2012)) => "Sviatok všetkých svätých - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 17, 2012)) => "Deň boja za slobodu a demokraciu - štátny sviatok", Time::get(mktime(0, 0, 0, 12, 24, 2012)) => "Štedrý deň - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 25, 2012)) => "Prvý sviatok vianočný - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 26, 2012)) => "Druhý sviatok vianočný - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 1, 1, 2013)) => "Deň vzniku Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 1, 6, 2013)) => "Zjavenie Pána (Traja králi) - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 3, 29, 2013)) => "Veľký piatok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 4, 1, 2013)) => "Veľkonočný pondelok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 1, 2013)) => "Sviatok práce - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 8, 2013)) => "Deň víťazstva nad fašizmom - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 7, 5, 2013)) => "Sviatok svätého Cyrila a Metoda - štátny sviatok", Time::get(mktime(0, 0, 0, 8, 29, 2013)) => "Výročie SNP - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 1, 2013)) => "Deň Ústavy Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 15, 2013)) => "Sedembolestná Panna Mária - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 1, 2013)) => "Sviatok všetkých svätých - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 17, 2013)) => "Deň boja za slobodu a demokraciu - štátny sviatok", Time::get(mktime(0, 0, 0, 12, 24, 2013)) => "Štedrý deň - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 25, 2013)) => "Prvý sviatok vianočný - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 26, 2013)) => "Druhý sviatok vianočný - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 1, 1, 2014)) => "Deň vzniku Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 1, 6, 2014)) => "Zjavenie Pána (Traja králi) - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 4, 18, 2014)) => "Veľký piatok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 4, 21, 2014)) => "Veľkonočný pondelok - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 1, 2014)) => "Sviatok práce - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 5, 8, 2014)) => "Deň víťazstva nad fašizmom - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 7, 5, 2014)) => "Sviatok svätého Cyrila a Metoda - štátny sviatok", Time::get(mktime(0, 0, 0, 8, 29, 2014)) => "Výročie SNP - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 1, 2014)) => "Deň Ústavy Slovenskej republiky - štátny sviatok", Time::get(mktime(0, 0, 0, 9, 15, 2014)) => "Sedembolestná Panna Mária - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 1, 2014)) => "Sviatok všetkých svätých - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 11, 17, 2014)) => "Deň boja za slobodu a demokraciu - štátny sviatok", Time::get(mktime(0, 0, 0, 12, 24, 2014)) => "Štedrý deň - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 25, 2014)) => "Prvý sviatok vianočný - deň pracovného pokoja", Time::get(mktime(0, 0, 0, 12, 26, 2014)) => "Druhý sviatok vianočný - deň pracovného pokoja",);
