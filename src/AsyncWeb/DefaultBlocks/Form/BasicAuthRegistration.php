...
Password: $pass";
    ...
    public function initTemplate() {
        $this->formSettings = $form = array("table" => "users", "col" => array(array("name" => Language::get("Gender"), "data" => array("col" => "gender"), "form" => array("type" => "select"), "filter" => array("type" => "option", "option" => array("m" => Language::get("Male"), "f" => Language::get("Female"),),),), array("name" => Language::get("First name"), "form" => array("type" => "textbox"), "data" => array("col" => "firstname"), "usage" => array("MFi", "MFu", "MFd")), array("name" => Language::get("Last name"), "form" => array("type" => "textbox"), "data" => array("col" => "lastname"), "usage" => array("MFi", "MFu", "MFd")), array("name" => Language::get("Email"), "form" => array("type" => "textbox"), "data" => array("col" => "email", "datatype" => "email"), "usage" => array("MFi", "MFu", "MFd")), array("name" => Language::get("Captcha"), "form" => array("type" => "captcha"), "data" => array("col" => "captcha"), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "submit"), "texts" => array("insert" => Language::get("Register"), "update" => "MF_update", "delete" => "MF_delete", "reset" => "MF_reset"), "usage" => array("MFi", "MFu", "MFd")),), "order" => array("od" => "asc",), "texts" => array("insertSuccess" => Language::get("You have successfully registered. We have sent you credentials to your email address.")), "uid" => "BasicAuthRegistration", "show_export" => true, "show_filter" => true, "allowInsert" => true, "allowUpdate" => false, "allowDelete" => false, "useForms" => true,
        //"rights"=>array(),
        "iter" => array("per_page" => "20"), "bootstrap" => true, "execute" => array("beforeInsert" => "PHP::\\AsyncWeb\\DefaultBlocks\\Form\\BasicAuthRegistration::beforeInsert()", "onInsert" => "PHP::\\AsyncWeb\\DefaultBlocks\\Form\\BasicAuthRegistration::onInsert()",),);
