...
$link";
    ...
    public function initTemplate() {
        $this->formSettings = $form = array("table" => "passwordrecovery", "col" => array(array("name" => Language::get("Your email address"), "form" => array("type" => "textbox"), "data" => array("col" => "email", "datatype" => "email"), "usage" => array("MFi", "MFu", "MFd")),
        //array("name"=>Language::get("Captcha"),"form"=>array("type"=>"captcha"),"data"=>array("col"=>"validacny_kod"),"usage"=>array("MFi","MFu","MFd")),
        array("form" => array("type" => "value"), "data" => array("col" => "code"), "texts" => array("text" => "PHP::\\AsyncWeb\\DefaultBlocks\\Form\\RecoverPassword::newCode()"), "usage" => array("MFi",)), array("form" => array("type" => "value"), "data" => array("col" => "created"), "texts" => array("text" => "PHP::time()"), "usage" => array("MFi",)), array("form" => array("type" => "submit"), "texts" => array("insert" => Language::get("Reset your password"), "update" => "MF_update", "delete" => "MF_delete", "reset" => "MF_reset"), "usage" => array("MFi", "MFu", "MFd")),), "uid" => "passwordrecovery", "texts" => array("insertSuccess" => Language::get("We have sent you password recovery link to your email address.")), "allowInsert" => true, "allowUpdate" => false, "allowDelete" => false, "useForms" => true,
        //"rights"=>array(),
        "iter" => array("per_page" => "20"), "bootstrap" => "1", "execute" => array("beforeInsert" => "PHP::\\AsyncWeb\\DefaultBlocks\\Form\\RecoverPassword::beforeInsert()", "onInsert" => "PHP::\\AsyncWeb\\DefaultBlocks\\Form\\RecoverPassword::onInsert()",),);
