...
class RecoverPasswordCode extends \AsyncWeb\DefaultBlocks\Form{
	...
	public function initTemplate(){
		...
		if(!URLParser::v("code")){
			...
			header("Location: /Content_Cat:Form_RecoverPassword/");exit;
		...
		$this->formSettings = $form = array(
			"table" => "users",
			"col" => array(
			 array("name"=>Language::get("New password"),"form"=>array("type"=>"password"),"data"=>array("col"=>"password","var"=>"newPass","cohash"=>"OFiapci@ifp##!Q-"),"usage"=>array("MFi","MFu","MFd")),
			 array("name"=>Language::get("Repeat password"),"form"=>array("type"=>"password"),"data"=>array("col"=>"password","var"=>"newPass2","cohash"=>"OFiapci@ifp##!Q-"),"usage"=>array("MFi","MFu","MFd")),
			),
			"where"=>array(
			 "id2"=>$usr["id2"],
			),
			...
			"execute"=>array(
				  "beforeUpdate"=>"PHP::\\AsyncWeb\\DefaultBlocks\\Form\\RecoverPasswordCode::beforeUpdate",
				  "onUpdate"=>"PHP::\\AsyncWeb\\DefaultBlocks\\Form\\RecoverPasswordCode::onUpdate",
			 ),					 
			);
