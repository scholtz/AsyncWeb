...
class DBMenu5 extends MenuBuilder {
    ...
    public function makeTopMenu(&$menu, $top = null, $showeditor = true) {
        ...
        while ($row = DB::f($res3)) {
            ...
            //
            if ($showeditor) {
                $menu2[$order * 100 + 1] = MenuItemBuilder::get(md5(uniqid()), '<i class="fa fa-plus-circle"></i>', Path::make(array("insert_data_dbmenu5_edit" => "1", "addmenuitemafter" => $row["id2"]), false, "?"));
            }
        }
        //exit;
        if (!$top) {
    ...
    public function check() {
        ...
        if ((@URLParser::v("addmenuitemsub") || @URLParser::v("addmenuitembefore") || @URLParser::v("addmenuitemafter") || @URLParser::v("editmenu") || @URLParser::v("deletemenu")) || Session::get("menuEditing")) {
            ...
            $form = array("table" => "menu", "col" => array(array("name" => "Path", "form" => array("type" => "textbox"), "data" => array("col" => "path", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd", "DBVs", "DBVe")), array("name" => "Text", "form" => array("type" => "textbox"), "data" => array("col" => "text", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("name" => "FA Icon", "form" => array("type" => "textbox"), "data" => array("col" => "fa"), "usage" => array("MFi", "MFu", "MFd")), array("name" => "ID3", "form" => array("type" => "textbox"), "data" => array("col" => "id3"), "usage" => array("MFu", "MFd")), array("name" => "Parent", "form" => array("type" => "selectDB"), "data" => array("col" => "parent", "allowNull" => true, "fromTable" => "menu", "fromColumn" => "path", "dictionary" => true, "where" => array("page" => MainMenu::$PAGE),), "texts" => array("nullValue" => "Vyber", "default" => "PHP::\AsyncWeb\Menu\DBMenu5::getUpperCategory()"), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Order", "form" => array("type" => "textbox"), "texts" => array("default" => "PHP::\AsyncWeb\Menu\DBMenu5::getInsertDefaultOrder()"), "data" => array("col" => "order", "datatype" => "number", "minnum" => - 100000, "maxnum" => 10000000), "filter" => array("type" => "number_format", "decimal" => "0", "desat_oddelocac" => ",", "oddelovac_tisicov" => "."), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Visible", "form" => array("type" => "checkbox"), "texts" => array("default" => "1"), "data" => array("col" => "visible", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Style", "form" => array("type" => "textbox"), "texts" => array("default" => "standard"), "data" => array("col" => "style"), "usage" => array("MFu", "MFd")), array("name" => "Title", "form" => array("type" => "textbox"), "data" => array("col" => "title", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Description", "form" => array("type" => "textbox"), "data" => array("col" => "description", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Keywords", "form" => array("type" => "textbox"), "data" => array("col" => "keywords", "dictionary" => true), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Type", "form" => array("type" => "select"), "data" => array("col" => "type", "datatype" => "enum"), "filter" => array("type" => "option", "option" => array("category" => Language::get("Category"), "image" => Language::get("Picture"), "src" => Language::get("Link"), "text" => Language::get("Text"))), "usage" => array("MFu", "MFd")), array("name" => "Path to picture", "form" => array("type" => "textbox"), "data" => array("col" => "img"), "usage" => array("MFu", "MFd")), array("name" => "Alt. Text", "form" => array("type" => "textbox"), "data" => array("col" => "imgalt", "dictionary" => true), "usage" => array("MFu", "MFd")), array("name" => "Picture height", "form" => array("type" => "textbox"), "data" => array("col" => "imgheight"), "usage" => array("MFu", "MFd")), array("name" => "Picture width", "form" => array("type" => "textbox"), "data" => array("col" => "imgwidth"), "usage" => array("MFu", "MFd")), array("name" => "Class", "form" => array("type" => "textbox"), "data" => array("col" => "class"), "usage" => array("MFu", "MFd")), array("name" => "Logintype", "form" => array("type" => "select"), "data" => array("col" => "logintype", "datatype" => "enum"), "filter" => array("type" => "option", "option" => array("all" => "Everyone see the category", "notlogged" => "Category is visible only to Unauthenticated", "logged" => "Category is visible only to Authenticated")), "usage" => array("MFi", "MFu", "MFd")), array("name" => "Group", "form" => array("type" => "selectDB"), "data" => array("dictionary" => true, "col" => "group", "allowNull" => true, "fromTable" => "groups", "fromColumn" => "name",), "texts" => array("nullValue" => "Select",), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "value"), "data" => array("col" => "page"), "texts" => array("text" => "PHP::\AsyncWeb\Menu\DBMenu5::getPage()"), "usage" => array("MFi", "MFu", "MFd")), array("form" => array("type" => "value"), "data" => array("col" => "type"), "texts" => array("value" => "category"), "usage" => array("MFi",)),), "where" => array("page" => MainMenu::$PAGE), "order" => array("od" => "asc",), "uid" => "dbmenu5_edit", "show_export" => true, "show_filter" => true, "allowInsert" => true, "allowUpdate" => true, "allowDelete" => true, "useForms" => true, "rights" => array("insert" => "MenuEditor", "update" => "MenuEditor", "delete" => "MenuEditor",), "execute" => array("onInsert" => "PHP::\AsyncWeb\Menu\DBMenu5::onInsert", "onUpdate" => "PHP::\AsyncWeb\Menu\DBMenu5::onUpdate", "onDelete" => "PHP::\AsyncWeb\Menu\DBMenu5::onDelete",), "iter" => array("per_page" => "20"),);
    ...
    public static function getUpperCategory() {
        switch (Session::get("addmenutype")) {
            case "addmenuitemsub":
                return Session::get("addmenuvalue");
    ...
    public static function import($xml) {
        ...
        foreach ($xpath->query("//menu") as $node) {
            ...
            foreach ($xpath->query("node()", $node) as $node2) {
                ...
                if (!$v) $v = null;
                $l = 0;
                foreach ($xpath->query("lang", $node2) as $node3) {
                    $l++;
    ...
    public function installDefaultValues() {
        $path = "Main";
        $id2 = md5(MainMenu::$PAGE . "-" . $path);
        Language::set($k = md5(uniqid()), $path);
        $path = $k;
