    ...
    public static function get() { //get($id2,$text,$path,$visible="1",$langs=array(),$run="",$fa=""){
        ...
        while (($arg = array_shift($args)) !== null) {
            ...
            if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\ID")) {
                $id2 = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Text")) {
                $text = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Path")) {
                $path = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Visibility")) {
                $visible = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Langs")) {
                if (is_array($arg->get())) {
                    $arr = $arg->get();
            ...
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Execute")) {
                $run = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\FA")) {
                $fa = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Submenu")) {
                $submenu = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Clazz")) {
                $class = $arg->get();
            } else if (is_a($arg, "\\AsyncWeb\\Menu\\Builder\\Type")) {
                $type = $arg->get();
            } else {
                switch ($i) {
                    case "1":
