...
class MenuItemBuilder{
	public static function get(){//get($id2,$text,$path,$visible="1",$langs=array(),$run="",$fa=""){
		$id2="";$text="";$path="";$visible="1";$langs=array();$run="";$fa="";$submenu = array();
		$args = func_get_args();
		$i = 0;
		...
		return array("id2"=>$id2,"path"=>$path,"title"=>$text,"text"=>$text,"type"=>"category","visible"=>$visible,"class"=>"","logintype"=>"all","group"=>null,"run"=>$run,"style"=>"standard","id"=>"","langs"=>$langs,"fa"=>$fa,"submenu"=>$submenu);
	}
}
