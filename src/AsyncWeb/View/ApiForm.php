...
class ApiForm {
  ...
  ';
        ...
        private function insertForm() {
            ...
            return \AsyncWeb\Text\Template::loadTemplate($Template, array("HeaderText" => $text, "HTML" => $ret, "Focus" => $Focus, "ID" => $ID, "Merged" => $this->merged, "SubmitURL" => $SubmitURL, "OnSubmit" => $OnSubmit, "EncType" => $EncType,), false, false);
        }
