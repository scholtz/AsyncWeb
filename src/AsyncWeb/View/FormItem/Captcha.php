...
class Captcha extends \AsyncWeb\View\FormItem\HTMLText {
    ...
    public function InsertForm($SubmittedValue = null) {
        ...
        $Template = "View_FormItem_Captcha";
        ...
        return \AsyncWeb\Text\Template::loadTemplate($Template, array("LabelText" => $LabelText, "Prepend" => $Prepend, "After" => $After, "ID" => $ID, "AddClass" => $AddClass, "Name" => $Name, "Value" => $Value, "Title" => $Help, "Placeholder" => $Placeholder, "DataContent" => $Help, "Disabled" => !$Editable, "HTML" => $ret, "BT_SIZE" => $this->item["BT_SIZE"], "BT_WIDTH_OF_LABEL" => $this->item["BT_WIDTH_OF_LABEL"], "BT_WIDTH_9" => $this->item["BT_WIDTH_9"], "BT_WIDTH_10" => $this->item["BT_WIDTH_10"], "DataValidation" => $DataValidation,), false, false);
    }
}
