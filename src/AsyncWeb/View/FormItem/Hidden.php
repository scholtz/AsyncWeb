...
class Hidden extends \AsyncWeb\View\FormItem\HTMLText {
    ...
    public function InsertForm($SubmittedValue = null) {
        ...
        return \AsyncWeb\Text\Template::loadTemplate($Template, array("LabelText" => $LabelText, "Prepend" => $Prepend, "After" => $After, "ID" => $ID, "AddClass" => $AddClass, "Type" => $Type, "Name" => $Name, "Value" => $Value, "MinLength" => $MinLength, "MaxLength" => $MaxLength, "Min" => $Min, "Max" => $Max, "Step" => $Step, "Title" => $Help, "Placeholder" => $Placeholder, "DataContent" => $Help, "DataPlacement" => $DataPlacement, "Disabled" => !$Editable, "Hidden" => true, "BT_SIZE" => $this->item["BT_SIZE"], "BT_WIDTH_OF_LABEL" => $this->item["BT_WIDTH_OF_LABEL"], "BT_WIDTH_9" => $this->item["BT_WIDTH_9"], "BT_WIDTH_10" => $this->item["BT_WIDTH_10"], "DataValidation" => $DataValidation,), false, false);
    }
}
